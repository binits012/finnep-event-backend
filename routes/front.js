...
router.route('/create-paytrail-payment-app')
...
router.route('/event/:eventId/seats/check-email-trust')
    .post(front.checkSeatEmailTrust)
router.route('/event/:eventId/seats/checkout-session')
    .get(front.getSeatCheckoutSession)
router.route('/event/:eventId/seats/release-session')
    .post(front.releaseSeatCheckoutSession)
