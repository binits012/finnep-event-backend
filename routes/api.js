...
router.get('/venue/:id/export', authenticate, requireAdmin, api.exportVenueById)
...
router.post('/venue/import', authenticate, requireAdmin, api.importVenue)
...
router.get('/manifest/:id/export', authenticate, requireAdmin, api.exportManifestById)
router.post('/manifest/import', authenticate, requireAdmin, api.importManifest)
